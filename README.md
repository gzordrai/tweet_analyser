...
- **File Upload**
  - Upload training or testing datasets via a file dialog using the `handle_upload()` method.
...
- **Model Training History**
  - Maintain a history of the last five model trainings, including model names, hyperparameters, and accuracy, stored in a JSON-based database.
